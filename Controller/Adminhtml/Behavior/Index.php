...
class Index extends Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('BrainStation23_Dubors::user_behavior');
        $resultPage->addBreadcrumb(__('DUBORS'), __('DUBORS'));
        $resultPage->addBreadcrumb(__('User Behavior'), __('User Behavior'));
        $resultPage->getConfig()->getTitle()->prepend(__('User Behavior'));
